...
for med in ['scalar','pseudo']:
    for ichi in range(len(chilist)):
        for iphi in range(len(philist)):
            filename=os.path.join(dirpath,"Output_"+med+"_LO_Mchi-"+str(chilist[ichi])+"_Mphi-"+str(philist[iphi])+".root")
