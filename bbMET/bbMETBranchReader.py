...
eleVetoCutBasedIDSFsFile = TFile('scalefactors/electron_Veto_cut-based_ID_SFs_egammaEffi_txt_EGM2D_2017.root')
eleVetoCutBasedIDSF_egammaEffi_txt_EGM2D = eleVetoCutBasedIDSFsFile.Get('EGamma_SF2D')

#Muon Trigger SFs
#BCDEF
muonTrigSFsRunBCDEFFile = TFile('scalefactors/muon_single_lepton_trigger_EfficienciesAndSF_2017.root')
muonTrigSFs_EfficienciesAndSF_RunBtoF = muonTrigSFsRunBCDEFFile.Get('IsoMu27_PtEtaBins/abseta_pt_ratio')

#Muon ID SFs
#BCDEF
muonIDSFsBCDEFFile = TFile('scalefactors/muon_ID_SFs_EfficienciesAndSF_BCDEF_2017.root')
...
#Muon Iso SFs
#BCDEF
muonIsoSFsBCDEFFile = TFile('scalefactors/muon_Iso_SFs_EfficienciesAndSF_BCDEF_2017.root')
...
#Muon Tracking SFs
muonTrackingSFsFile = TFile('scalefactors/muon_Tracking_SFs_Tracking_EfficienciesAndSF_BCDEF_2016.root')
        ...
        if nEle==1 and nMu==0 and nTauTightElectron==0 and EleCRtrigstatus and WenuRecoil>200. and jetcond and Wenumass<160. and pfMet > 50.:
            ...
            if myEles[iLeadLep].Pt() > 30. and myEleTightID[iLeadLep]:
                ...
                if  nBjets==1 and WdPhicond and (nJets-nBjets)==0:
                    ...
                    if options.CSV:
                        allquantities.reg_1e1b_jet1_csv = mybJet_disc[ifirstjet]
                        if nJets>1: allquantities.reg_1e1b_jet2_csv = mybJet_disc[isecondjet]
                    ...
                    if options.DeepCSV:
                        allquantities.reg_1e1b_jet1_deepcsv = mybJet_disc[ifirstjet]
                        if nJets>1: allquantities.reg_1e1b_jet2_deepcsv = mybJet_disc[isecondjet]
            ...
            #1e, 2 b-tagged
                ...
                if nBjets==2 and SR2jet2 and WdPhicond and (nJets-nBjets)==0:
                    ...
                    if options.CSV:
                        allquantities.reg_1e2b_jet1_csv = mybJet_disc[ifirstjet]
                        if nJets>1: allquantities.reg_1e2b_jet2_csv = mybJet_disc[isecondjet]
                    ...
                    if options.DeepCSV:
                        allquantities.reg_1e2b_jet1_deepcsv = mybJet_disc[ifirstjet]
                        if nJets>1: allquantities.reg_1e2b_jet2_deepcsv = mybJet_disc[isecondjet]
        ...
        if nMu==1 and nEle==0 and nTauTightMuon==0 and MuCRtrigstatus and WmunuRecoil>200. and jetcond and Wmunumass<160. and pfMet > 50.:
            ...
            #1mu, 2 b-tagged
                ...
                if nBjets==2 and SR2jet2 and WdPhicond and (nJets-nBjets)==0:
                    ...
                    if options.CSV:
                        allquantities.reg_1mu2b_jet1_csv = mybJet_disc[ifirstjet]
                        if nJets>1: allquantities.reg_1mu2b_jet2_csv = mybJet_disc[isecondjet]

                    if options.DeepCSV:
                        allquantities.reg_1mu2b_jet1_deepcsv = mybJet_disc[ifirstjet]
                        if nJets>1: allquantities.reg_1mu2b_jet2_deepcsv = mybJet_disc[isecondjet]
