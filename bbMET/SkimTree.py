...
#    NEntries = 1000
    ...
    for ievent in range(NEntries):
        ...
        passThinJetLooseID         = skimmedTree.__getattr__('AK4deepCSVjetPassIDLoose')
        THINjetHadronFlavor        = skimmedTree.__getattr__('AK4deepCSVjetHadronFlavor')
        THINjetNPV                 = skimmedTree.__getattr__('AK4deepCSVjetNPV')
        thinjetNhadEF              = skimmedTree.__getattr__('AK4deepCSVjetNHadEF')
        thinjetChadEF              = skimmedTree.__getattr__('AK4deepCSVjetCHadEF')
        thinjetCEmEF               = skimmedTree.__getattr__('AK4deepCSVjetCEmEF')
        thinjetPhoEF               = skimmedTree.__getattr__('AK4deepCSVjetPhoEF')
        thinjetEleEF               = skimmedTree.__getattr__('AK4deepCSVjetEleEF')
        thinjetMuoEF               = skimmedTree.__getattr__('AK4deepCSVjetMuoEF')
        thinjetCorrUnc             = skimmedTree.__getattr__('AK4deepCSVjetCorrUncUp')
