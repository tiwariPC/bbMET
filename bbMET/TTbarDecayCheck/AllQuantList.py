...
#                       allquantlist.append(lep+"1_"+lepprop+"_"+region+nSR)
        ...
        for quantname in ['met','jet1_nhf','jet1_chf','met_0l','met_minus1l']:
