...
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        if EleCRtrigstatus:
            ...
            if nEle==1 and nMu==0 and myEles[0].Pt() > 30. and myEleTightID[0] and abs(myEles[0].Eta()) <= 2.1:# and myEleTightID[0]:
  ...
  #Cutflow
        if MuCRtrigstatus:
            ...
            if nEle==0 and nMu==1 and myMuos[0].Pt() > 30. and myMuTightID[0] and myMuIso[0]<0.15:# and myMuTightID[0] and myMuIso[0]<0.15:
